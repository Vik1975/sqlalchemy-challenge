...
def home():
    return (
        f"Welcome to the home page for Hawaii Climate Analysis API!<br/>"
        f"Available Routes:<br/>"
        f"/api/v1.0/precipitation<br/>"
        f"/api/v1.0/stations<br/>"
        f"/api/v1.0/tobs<br/>"
        f"/api/v1.0/start (enter as YYYY-MM-DD for example: http://127.0.0.1:5000/api/v1.0/2017-08-16)<br/>"
        f"/api/v1.0/start/end (enter as YYYY-MM-DD/YYYY-MM-DD for example: http://127.0.0.1:5000/api/v1.0/2017-08-16/2017-08-19)"
...
def stations():
    ...
    for station,name,lat,lon,el in query_result:
        ...
        station_dict["Station Lon"] = lon
        station_dict["Station Elevation"] = el
